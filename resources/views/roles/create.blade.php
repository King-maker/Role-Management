        ...
        <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                         <div class="panel-heading">Create New Role
                        </div>
                        ...
                        <form class ="form-horizontal" role="form" method="POST" action ="{{url('admin/roles')}}">
                            ...
                            <div class="form-group{{ $errors->has('permissions') ? 'has-error' : ''}}">
                                <label for ="display_name" class ="col-md-4 control-label">Permissions:</label>

                                <div class="col-md-6">
                                @foreach($permissions as $permission)
                                    <input type="checkbox"   name="permissions[]" value=" {{$permission}} "><br>
                                @endforeach
